...
public class WallSouth extends Wall{
	...
	public WallSouth(float x, float y, int width, int height, boolean hasDoor) {
		...
		wallWhenNoDoor = new Quad(x-(width-DOOR_WIDTH)/2-DOOR_WIDTH/2, y-WALL_THICKNESS/2, DOOR_WIDTH, WALL_THICKNESS, ShapeType.QUAD);
